    ...
    <div class="login">
        <form>
            ...
            <div class="form-outline mb-4">
                ...
                <input type="email" id="form2Example1" class="form-control grey_text" v-model="email" placeholder="Enter Email Address"/>
            </div>
            ...
            <div class="form-outline mb-4">
                ...
                <!-- Forget Password -->
                <label class="pwd grey_text" data-bs-toggle="modal" data-bs-target="#forgetpasswordModal"><u>Forget Password?</u></label>
                
                <div class="d-flex">
                    <input type="password" id="form2Example2" class="form-control" v-model="pwd" placeholder="Enter Password"/>
                    <span class="material-symbols-outlined" @click="ShowHide()">{{visible}}</span>
                </div>
